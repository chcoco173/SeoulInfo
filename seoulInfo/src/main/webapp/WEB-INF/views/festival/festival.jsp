			...
			<div data-animation="default" data-collapse="medium"
				...
				<div class="nav-wrapper">
					...
					<div class="links-and-search-wrapper">
						<nav role="navigation" class="nav-links-wrapper w-nav-menu">
							<a href="about.html" class="nav-link w-nav-link">About</a> <a
								href="contact.html" aria-current="page"
								class="nav-link w-nav-link w--current">Contact</a>
						</nav>
						<form action="/search"
					...
					<div class="menu-button w-nav-button">
						<img src="../images/ph_list-light-xsmall.svg" loading="lazy"
							alt="" class="icon-1x1-xsmall">
					</div>
				</div>
			</div>
		</div>
