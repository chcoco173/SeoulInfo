...
<body>
	<div class="page-wrapper"><!-- 검색 start -->
							...
							<div class="w-dyn-list">
								...
								<div>
									<div id="w-node-f17ecf68-c6ad-5661-f6e1-8708d30b8475-65b830fb">
										...
										<a href="/mypage/profile" class="tag-t w-inline-block">프로필
											관리</a> <a href="/mypage/memberInfo" class="tag-t w-inline-block">개인정보
											관리</a> <a href="/mypage/product" class="tag-t w-inline-block">관심상품
											목록</a> <a href="/mypage/ev" class="tag-t w-inline-block">충전소
											즐겨찾기</a> <a href="/mypage/question" class="tag-t w-inline-block">1
											: 1 문의</a>
									</div>
								</div>
								<!-- 한)마이페이지 탭 end-->
								...
								<div>
									...
									<div class="w-dyn-list">
										<div role="list" class="w-dyn-items">
											<div data-w-id="1d188613-99eb-7eb0-d878-0bf26f04f385"
												style="opacity: 0" role="listitem" class="w-dyn-item">
												<div class="post-row-grid">
													<!-- 프로필 사진 -->
													<c:choose>
														<c:when
															test="${sessionScope.member.member_imageName == null}">
															<a id="w-node-dbd1f4aa-0c13-168c-7fc5-367d8d676b4b-4f5c4820"
																data-w-id="dbd1f4aa-0c13-168c-7fc5-367d8d676b4b" href=""
														...
														<c:otherwise>
															<a
																id="w-node-dbd1f4aa-0c13-168c-7fc5-367d8d676b4b-4f5c4820"
																data-w-id="dbd1f4aa-0c13-168c-7fc5-367d8d676b4b" href=""
																class="post-row-image-overflow-container w-inline-block">
																
																	<img
																		src="/files/${sessionScope.member.member_imageName}">
									...
									<form action="updateProfile" method="post"
										enctype="multipart/form-data" class="tag-b w-inline-block">
										<input type="hidden" name="member_id" id="id"
											value="${sessionScope.member.member_id}"> <input
											type="file" name="file" id="file"
											class="tag-b w-inline-block"> <input type="submit"
											value="등록" class="tag-a w-inline-block">
									</form>

									<!-- 삭제 버튼 -->
									<form action="deleteProfile" method="post"
										class="tag-b w-inline-block">
										<input type="hidden" name="member_id" id="id"
											value="${sessionScope.member.member_id}"> <input
											type="submit" value="삭제" class="tag-a w-inline-block">
									</form>
								</div>
								<!-- 한)마이페이지 상세 end-->
							</div>
