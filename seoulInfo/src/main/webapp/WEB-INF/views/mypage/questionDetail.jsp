...
<head>
  ...
  function openInquiryForm() {
    window.open('inquiryFormURL', '_blank', 'width=600,height=400');
  }
 </script>
	            ...
	            <div class="category-inquiry-container">
	              <div class="category-container">
	                ...
	                <select id="category-select" name="category">
	                  ...
	                  <option value="category3">전기차</option>
	                </select>
	              </div>
	              <button class="inquiry-button" onclick="openInquiryForm()">1:1 문의하기</button>
	            </div>            
