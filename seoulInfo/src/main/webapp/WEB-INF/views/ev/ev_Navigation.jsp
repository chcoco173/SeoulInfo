				...
				$("#btn_select")
						.click(
								function() {
									...
									var headers = {}; 
										headers["appKey"]="B6cVULpkYQ5bwF3CIw3lF1YfFgRjCgYs9E0aFLuP";

									//JSON TYPE EDIT [S]
									$.ajax({
										type : "POST",
										headers : headers,
										url : "https://apis.openapi.sk.com/tmap/routes?version=1&format=json&callback=result&appKey=B6cVULpkYQ5bwF3CIw3lF1YfFgRjCgYs9E0aFLuP",
										async : false,
										data : {
