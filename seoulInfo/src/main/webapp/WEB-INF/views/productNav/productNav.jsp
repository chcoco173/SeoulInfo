			...
			<div class="nav-wrapper">
				...
				<div class="links-and-search-wrapper">
					<nav role="navigation" class="nav-links-wrapper w-nav-menu">
						...
						<a href="productCategory?cate=전자제품" class="style-guide-nav-link w-nav-link">전자제품</a>
						<a href="productCategory?cate=생활용품" class="style-guide-nav-link w-nav-link">생활용품</a>
